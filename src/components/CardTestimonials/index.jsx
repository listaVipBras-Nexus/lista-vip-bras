...
const CardTestimonials = ({ data }) => {
    ...
    return (
        <motion.article
            ...
            className="w-11/12 h-72  bg-nbBlackTertiary rounded-3xl flex flex-col items-center justify-around cursor-pointer transition-all duration-200 ease-out hover:!scale-102 s380:max-w-96 s680:max-w-md s1180:h-full s1180:w-full "
        >
            <div className="w-4/5 flex justify-start items-center gap-4">
                ...
                <div className="flex flex-col text-white">
                    ...
                    <p className="w-fit text-neutral-300 text-sm s1180:text-xs">
                        {data.cargo}
                    </p>
                </div>
            </div>
